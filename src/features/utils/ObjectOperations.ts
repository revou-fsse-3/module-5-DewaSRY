...
function getObjectKey<T extends ParamObject>(obj: T) {
  return Object.keys(obj);
}
function getObjectValues<T extends ParamObject>(obj: T) {
...
function getObjectToStringArr<T extends ParamObject>(
  obj: T,
  strArr: string[] = []
): string[] {
